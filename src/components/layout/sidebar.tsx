    ...
    items: [
      ...
      { href: "/admin/financeiro/receitas/doacoes", label: "Doações", icon: Heart },
      {
        ...
        children: [
          ...
          { href: "/admin/financeiro/receitas/paes/inadimplentes", label: "Em Aberto", icon: AlertCircle },
      ...
      items: [
        ...
        { href: "/tesoureiro/receitas/doacoes", label: "Doações", icon: Heart },
        {
          ...
          children: [
            ...
            { href: "/tesoureiro/receitas/paes/inadimplentes", label: "Em Aberto", icon: AlertCircle },
