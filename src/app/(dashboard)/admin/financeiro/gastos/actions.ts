...
export async function criarGastoAction(formData: GastoFormData) {
  try {
    ...
    revalidatePath(`/admin/financeiro/gastos/eventos/${formData.eventoId}`);
...
export async function excluirGastoAction(id: string, eventoId: string) {
  try {
    ...
    revalidatePath("/admin/financeiro/gastos");
    revalidatePath("/admin/financeiro");
    revalidatePath(`/admin/financeiro/gastos/eventos/${eventoId}`);
...
export async function criarEventoAction(formData: EventoFormData) {
  try {
    ...
    revalidatePath("/admin/financeiro/gastos/eventos");
...
export async function atualizarEventoAction(
  ...
  try {
    ...
    revalidatePath("/admin/financeiro/gastos/eventos");
    revalidatePath(`/admin/financeiro/gastos/eventos/${id}`);
