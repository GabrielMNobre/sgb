...
function revalidateAcampamento(acampamentoId: string) {
  ...
  revalidatePath(`/tesoureiro/acampamentos/${acampamentoId}/participantes`);
  revalidatePath(`/tesoureiro/acampamentos/${acampamentoId}/pagamentos`);
  revalidatePath(`/tesoureiro/acampamentos/${acampamentoId}/gastos`);
