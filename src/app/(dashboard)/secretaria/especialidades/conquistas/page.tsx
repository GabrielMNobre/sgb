...
export default async function ConquistasPage() {
  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      <div>
        <h1 className="text-xl sm:text-2xl font-bold text-gray-900">Conquistas</h1>
        <p className="text-sm sm:text-base text-gray-500">Gerencie as especialidades conquistadas pelos membros</p>
      </div>
