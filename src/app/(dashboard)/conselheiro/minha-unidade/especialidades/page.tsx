...
export default async function ConselheiroEspecialidadesPage() {
  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      <div>
        <h1 className="text-xl sm:text-2xl font-bold text-gray-900">Especialidades - <span style={{ color: "var(--unit-primary)" }}>{unidadeInfo.unidadeNome}</span></h1>
        <p className="text-sm sm:text-base font-medium" style={{ color: "var(--unit-primary)" }}>Gerencie as especialidades dos membros da sua unidade</p>
      </div>
